...
class Miner(BaseMinerNeuron):
    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen15_7_8_550____bon_090_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml15_7",
                "model_version": "15.7",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml15_7",
                "repo_commit": git_commit,
                "notes": "Gen15-7 neural network scorer (artifact gen15_7_8_550____bon_090_hardened)",
                "open_source": True,
    ...
    async def forward(self, synapse: DetectionSynapse) -> DetectionSynapse:
        ...
        synapse.predictions = [s >= 0.01 for s in scores]
        ...
        bt.logging.info(f"Scored {len(chunks)} chunks with scorer ml15_7.")
        return synapse
...
if __name__ == "__main__":
    ...
    with Miner() as miner:
        ...
        while True:
            bt.logging.info(
                f"Miner UID: {miner.uid} | Incentive: {float(miner.metagraph.I[miner.uid])} | Scorer: ml15_7"
            )
            time.sleep(60)
